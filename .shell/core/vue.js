		...
		},
		{
			...
			action: async (arg) => {
				...
				await core.createProject('vue', () => {
					...
					copy(this.root + 'router.js', this.config.directory.route + '/index.js', () => {})
					copy(this.root + 'Home.vue', this.config.directory.route + '/Home.vue', () => {})
					copy(this.root + 'storeindex.js', this.config.directory.store + '/index.js', () => {})
