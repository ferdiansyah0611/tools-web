  ...
  this.action = [
    {
      ...
      action: (arg) => {
        var { createDirRecursive, read, write, caseName } = this.init(arg);
          ...
          if (
            ...
            var exec =
              ...
              (sh.isProduction
                ? " && cd " +
                  folder +
                  ` && npm i && npm i cors express-session bcrypt express-validator jsonwebtoken uuid module-alias dotenv ${db} --save && npm i mocha supertest -D` +
